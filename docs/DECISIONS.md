...
1. **iCal export token** (Moodle → Preferences → Calendar export): permanent-ish URL, gives assignment deadlines + course events officially. Cheap and reliable; implement first.
